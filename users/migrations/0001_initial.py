    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img_picture', django_resized.forms.ResizedImageField(blank=True, crop=None, force_format='JPEG', keep_meta=True, null=True, quality=90, size=[512, 512], upload_to=users.models.picture)),
                ...
                ('owner_position_description', tinymce.models.HTMLField(blank=True, null=True, verbose_name='Descripción del puesto')),
